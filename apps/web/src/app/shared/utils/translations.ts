    ...
    EXPERIENCES: [
      {
        ...
        company: 'Remoto',
        date: 'Jun 2024 – Oct 2025',
        description: 'Diseñé y desarrollé aplicaciones web empresariales escalables utilizando Angular (v12-v20) y .NET Core. Lideré la creación de principio a fin de plataformas de citas complejas y migré formularios dinámicos pesados.'
      },
      {
        role: 'Desarrollador Full Stack',
        company: 'Ekisa | Híbrido',
        date: 'Mar 2023 – Jun 2024',
        description: 'Optimicé el rendimiento de SPAs en Angular 12+ implementando estrategias de renderizado avanzadas e integrando APIs REST de .NET Core. Desarrollé una biblioteca interna de componentes UI utilizando DevExtreme, eliminando la duplicación de código y acelerando la entrega de características.'
      },
      {
        role: 'Practicante de Desarrollo de Software',
        company: 'Ekisa | Presencial',
        date: 'Sep 2022 – Mar 2023',
        description: 'Construí interfaces de usuario reactivas en Angular 12+ y consumí APIs de .NET Core para respaldar flujos de trabajo internos de la empresa. Colaboré en la migración y validación de formularios dinámicos.'
      }
    ],
