...
@Component({
  ...
  standalone: true,
  template: `
<div class="group bg-transparent border border-base-content/5 rounded-md overflow-hidden transition-all duration-500 flex"
  [class.flex-col]="true" [class.md:flex-row]="view() === 'list'">
  <!-- Image Skeleton -->
  <div class="relative overflow-hidden shrink-0 border-base-content/5" [class.w-full]="true"
  ...
  <div class="p-6 md:p-8 grow flex flex-col gap-4">
    <div class="flex flex-wrap items-center gap-2 mb-2">
      <div class="skeleton h-6 w-16 rounded-md opacity-30"></div>
      <div class="skeleton h-6 w-20 rounded-md opacity-30"></div>
      <div class="skeleton h-6 w-14 rounded-md opacity-30"></div>
    </div>
